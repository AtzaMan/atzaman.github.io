...
const broker = 'wss://mqtt.flespi.io';
...
let options = {
  ...
  clientId: 'mqttJsClient_'+ Math.random().toString(16),
  // add these in for public.cloud.shiftr.io:
  username: 'OK6tJ2nhulcncMpbtOBfhKxvZdQhbC4J2nynXA2bfhMD5tCf9tDSJC6QQPAV5kzH',
  password: ''
}
